...
let displaySellerProduct = () => {
    ...
    for (let index in all_products) {
        ...
        i_edit.className="fa fa-pencil-square-o i_edit";
        i_edit.addEventListener("click",edit);

        let i_delete= document.createElement("i");
        i_delete.className="fa fa-trash i_delete"
        i_delete.addEventListener("click",deleteProduct);

        action.append(btn1,i_edit, i_delete, btn2);
...
function scrollProgress(){
    ...
    document.querySelector(".progress_scroll").style.width=scrolled+"%";
}
